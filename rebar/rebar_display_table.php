...
class RebarDisplayTable {
    ...
    public function display(RebarItemList $cl, $paged = false) {
        ...
        //headings
        $out = array_merge($out, $this->getTableHeaderHtml());
    ...
    protected function getActionCellMarkup($action, $id, $must_have_placement = '') {
